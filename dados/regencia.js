...
const REGENCIA = {
  ...
  1: {
    ...
    blocos: [
      ...
      { h: "A batuta",
        ...
        fig: "reg-batuta" },
      { h: "A mão sem batuta",
        t: "Nas aulas práticas rege-se com batuta. A mão sem batuta fica para a esquerda, e para um ensaio de naipe em que a batuta falte: mão aberta, dedos juntos e soltos, palma para baixo, o ponto do tempo na ponta dos dedos. Com ou sem batuta, o gesto nasce do antebraço, com o punho solto, e não do ombro." },
  ...
  10: {
    ...
    blocos: [
      ...
      { h: "Mudança súbita",
        t: "Súbito quer dizer de repente: o forte que vira piano de uma vez, sem diminuir aos poucos — o contrário do crescendo e do diminuendo, que são graduais. Não há como pedir o piano súbito depois que o som já saiu forte; ele se pede na preparação: o último gesto antes dele já é pequeno e leve, e a mão esquerda, de palma para baixo, confirma." },
      { h: "No hinário",
        t: "O hinário oficial não traz sinais de dinâmica: segue-se a dinâmica natural, pela poesia do hino e pelo discurso musical, como ensina o MSA. Antes de reger, marque a lápis onde a letra e a frase pedem mais ou menos som, e decida o tamanho do gesto em cada trecho." },
    ],
    pratica: [
      ...
      "Nos hinos desta fase, o regente decide antes, pela letra, onde o som cresce e diminui, e mostra tudo só com o gesto, sem dizer nada com palavras.",
    ],
  },
