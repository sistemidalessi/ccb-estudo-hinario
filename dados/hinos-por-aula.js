...
const HINOS_AULA = [
  ...
  {p:4, a:[4,5], tipo:"complementar", rot:"Síncopa", conf:"conferir",
   ...
   nota:"No caderno, síncopa e contratempo vêm em duas colunas lado a lado; a leitura automática do PDF separou as colunas pela numeração crescente. Conferir no impresso antes de usar em prova."},
  {p:4, a:[4,5], tipo:"complementar", rot:"Contratempo", conf:"conferir",
   ...
   nota:"Mesma ressalva da lista de síncopa."},
